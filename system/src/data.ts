...
import { citySampleModel } from "./app/shared/models/cityModel";

export const city_sample:TreeNode<string>[] = Object.entries({
  "基隆市": [
...
export const price: TreeNode<string>[] = [
  {
    label: '5000元以下',
    data: '0_5000',
  },
...
export const room: TreeNode<string>[] = [
  {
    label: '1房',
    data: '1',
  },
...
export const floor: TreeNode<string>[] = [
  {
    label: '1樓以下',
    data: '1',
  },
